...
class Chart extends Component{
                        ...
                        datasets:[
                          {
                            ...
                            backgroundColor:[
                              ...
                              'rgba(153, 102, 255, 0.5)', 'rgba(255, 159, 64, 0.5)',  'rgb(255, 100, 0, 0.5)',     'rgb(255, 255, 0, 0.5)',
                              'rgba(104, 162, 235, 0.5)', 'rgb(218, 165, 32, 0.5)',    'rgba(54, 162, 235, 0.5)',   'rgb(250,235,215,0.5)',
                              'rgba(75, 192, 192, 0.5)',  'rgba(153, 102, 255, 0.5)', 'rgb(255, 0, 191,0.5)',       'rgb(0,128,128,0.5)',
                              'rgb(106,90,205,0.5)',          'rgb(135,206,235,0.5)',         'rgba(255, 99, 132, 0.5)',   'rgba(54, 162, 235, 0.5)',
                              'rgba(255, 206, 86, 0.5)',  'rgba(75, 192, 192, 0.5)',  'rgb(180,0,0,0.5 )',               'rgba(255, 159, 64, 0.5)',
                              'rgb(0,128,128,0.5)',           'rgba(95, 192, 95, 0.5)',   'rgba(104, 162, 235, 0.5)',  'rgba(255, 99, 0, 0.5)',
                              'rgba(54, 55, 235, 0.5)',  '	rgb(0, 200, 255,0.5)',        'rgba(75, 255, 192, 0.5)',   'rgba(255, 0, 0, 0.5)',
                              'rgba(0, 255, 0, 0.6)',  ' rgb(0, 255, 255)',           'rgba(255, 128, 0, 0.5)',    'rgba(128, 128, 128,0.5)',
                            ...
                            borderColor:[
                              'rgba(255, 99, 132)',  'rgba(54, 162, 235)',  'rgba(255, 206, 86)',   'rgba(75, 192, 192)',
                              'rgba(153, 102, 255)', 'rgba(255, 159, 64)',  'rgb(255, 100, 0)',     'rgb(255, 255, 0)',
                              'rgba(104, 162, 235)', 'rgb(218, 165, 32)',    'rgba(54, 162, 235)',   'rgb(250,235,215)',
                              'rgba(75, 192, 192)',  'rgba(153, 102, 255)', 'rgb(255, 0, 191)',       'rgb(0,128,128)',
                              'rgb(106,90,205)',          'rgb(135,206,235)',         'rgba(255, 99, 132)',   'rgba(54, 162, 235)',
                              'rgba(255, 206, 86)',  'rgba(75, 192, 192)',  'rgb(180,0,0 )',               'rgba(255, 159, 64)',
                              'rgb(0,128,128)',           'rgba(95, 192, 95)',   'rgba(104, 162, 235)',  'rgba(255, 99, 0)',
                              'rgba(54, 55, 235)',  '	rgb(0, 200, 255)',        'rgba(75, 255, 192)',   'rgba(255, 0, 0)',
                              'rgba(0, 255, 0)',  ' rgb(0, 255, 255)',           'rgba(255, 128, 0)',    'rgba(128, 128, 128)',
                              'rgba(32, 64, 128)',  ' rgb(128, 0, 128)',         'rgba(128, 64, 64)',    'rgba(255, 128, 128)',
                              'rgba(192, 255, 0)',  ' rgb(0, 0, 128)',           'rgba(201, 201, 32)',   'rgba(160, 192, 128)',
                            ]
                          }
                        ]
                      }//end chartdata
  ...
  getCustomersChartData(){
    ...
    $.ajax({
               ...
               success: function (result) {
                   //("versions-->"+JSON.stringify(result));
